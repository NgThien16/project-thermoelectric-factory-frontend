...
export default function ReplacementImport() {
    ...
    const handleChange = (e) => {
        ...
        if (name === "materialId" && value === "/replacement-materials/add") {
                            ...
                            <Row className="g-3 align-items-end">
                                ...
                                <Col md={6}>
                                    ...
                                    >
                                        ...
                                        <option value="/replacement-materials/add" className="fw-bold text-primary">
